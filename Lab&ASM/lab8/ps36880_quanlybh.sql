...
--
-- Host: localhost    Database: ps36680_quanlybh
-- ------------------------------------------------------
...
CREATE TABLE `khachhang` (
  ...
  PRIMARY KEY (`MaKH`),
  UNIQUE KEY `uni_id_sdt_khachhang` (`DienThoai`),
  UNIQUE KEY `uni_id_email_khachhang` (`Email`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `khachhang` VALUES ('KH001','Trần Trọng','Trí','Gò Vấp',NULL,'0983456654'),('KH002','Đàm Vĩnh','Hưng','Quận 3',NULL,'0988123567'),('KH003','Châu Đăng','Khoa','Quận 1',NULL,'0977874300'),('KH004','Phạm','Hương','Quận 2',NULL,'0903090932'),('KH005','Trường','Giang','Bình Thạnh',NULL,'0933411154'),('KH006','Hoài','Linh','Phú Nhuận',NULL,'0888012381'),('KH007','Mỹ','Tâm','Quận 1',NULL,'0977456654'),('KH008','Ưng Hoàng','Phúc','Quận 5',NULL,'091950064'),('KH009','Châu Tinh','Trì','Quận 1',NULL,'0888456098'),('KH010','Thành','Long','Quận 2',NULL,'0903090908'),('KH011','Lý Liên','Kiệt','Tân Bình',NULL,'0933410054'),('KH012','Châu Khải','Phong','Quận 1',NULL,'0888022411'),('KH013','Vân Quang','Long','Quận 12',NULL,'0983456633'),('KH014','Châu Việt','Cường','Quận 8',NULL,'0988903664'),('KH015','Ngọc','Sơn','Quận 10',NULL,'0977766098'),('KH016','Nguyễn Phi','Hùng','Quận 12',NULL,'0903098032'),('KH017','Trịnh Thăng','Bình','Bình Thạnh',NULL,'0933477754'),('KH018','Sơn','Tùng M-TP','Tân Phú',NULL,'0888029999'),('KH019','Ngô Thanh','Vân','Tân Bình',NULL,'0983456890'),('KH020','Trương Quỳnh','Anh','Quận 3',NULL,'0888053664'),('KH021','Hoàng Thùy','Linh','Quận 1',NULL,'0977000098'),('KH022','Tóc','Tiên','Quận 2',NULL,'0903090888'),('KH023','Bích','Phương','Quận 1',NULL,'0933411010'),('KH024','Thu','Minh','Quận 9',NULL,'0888022223');
...
-- Dump completed on 2023-07-22 10:15:42
